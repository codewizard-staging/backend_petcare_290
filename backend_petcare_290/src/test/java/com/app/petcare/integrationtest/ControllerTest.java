...
class ControllerTest {
  ...
  given()
   ...
   given()
            .when()
            .get("/petcare/PetCareCenters?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/petcare/PetCareCenters/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM petcare_089.PetService");
    jdbcTemplate.execute("DELETE FROM petcare_089.PetOwner");
    jdbcTemplate.execute("DELETE FROM petcare_089.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM petcare_089.Manager");
    jdbcTemplate.execute("DELETE FROM petcare_089.Document");
    jdbcTemplate.execute("DELETE FROM petcare_089.Pet");
     jdbcTemplate.execute("DELETE FROM petcare_089.PetCareCenterServices");
     jdbcTemplate.execute("DELETE FROM petcare_089.PetCareCenterBusinessHours");
     jdbcTemplate.execute("DELETE FROM petcare_089.PetOwnerPets");
     jdbcTemplate.execute("DELETE FROM petcare_089.PetCareCenterImages");
     jdbcTemplate.execute("DELETE FROM petcare_089.PetCareCenterPets");
